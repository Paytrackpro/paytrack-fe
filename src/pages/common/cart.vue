    ...
    <q-card-section class="card-header q-pa-sm">
      <div class="row justify-between">
        ...
        <div class="row align-center">
          <p class="text-weight-medium text-primary">{{ isCheckout ? 'Total Payment:' : 'Total:' }}</p>
          ...
          <q-btn
            ...
            color="primary"
            class="q-mx-sm btn btn-animated"
            :disable="phoneNumber == '' || address == ''"
            @click="createBill()"
          >
            <q-tooltip v-if="phoneNumber == '' || address == ''"
              >Phone number and address cannot be left blank</q-tooltip
            >
          </q-btn>
        </div>
      </div>
      ...
      <div class="col-12 q-pa-sm">
        <div class="shadow-primary q-pa-sm">
          <div class="row q-mx-sm q-mt-sm">
            ...
            <p class="text-weight-medium text-size-15">Delivery Address</p>
          </div>
          <div class="row q-mx-sm q-py-sm align-center">
